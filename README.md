...
```
cd existing_repo
git remote add origin https://gitlab.computing.dcu.ie/jmckenna/2026-csc1025-group-project.git
git branch -M main
...
* [Set up project integrations](https://gitlab.computing.dcu.ie/jmckenna/2026-csc1025-group-project/-/settings/integrations)
